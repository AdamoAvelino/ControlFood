...
-- Copiando estrutura para tabela laribolo_editado.cliente
...
-- Copiando dados para a tabela laribolo_editado.cliente: ~149 rows (aproximadamente)
DELETE FROM `cliente`;
...
-- Copiando estrutura para tabela laribolo_editado.compra
...
-- Copiando dados para a tabela laribolo_editado.compra: ~3 rows (aproximadamente)
DELETE FROM `compra`;
...
-- Copiando estrutura para tabela laribolo_editado.compra_item
...
CREATE TABLE IF NOT EXISTS `compra_item` (
  ...
  CONSTRAINT `id_ingrediente.compra_item-ingrediente.id` FOREIGN KEY (`id_ingrediente`) REFERENCES `produtos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Copiando dados para a tabela laribolo_editado.compra_item: ~11 rows (aproximadamente)
...
-- Copiando estrutura para tabela laribolo_editado.entrada
...
-- Copiando dados para a tabela laribolo_editado.entrada: ~9 rows (aproximadamente)
DELETE FROM `entrada`;
...
-- Copiando estrutura para tabela laribolo_editado.entrega
...
-- Copiando dados para a tabela laribolo_editado.entrega: ~0 rows (aproximadamente)
DELETE FROM `entrega`;
/*!40000 ALTER TABLE `entrega` DISABLE KEYS */;
/*!40000 ALTER TABLE `entrega` ENABLE KEYS */;

-- Copiando estrutura para tabela laribolo_editado.ingrediente_depreciado
...
-- Copiando dados para a tabela laribolo_editado.ingrediente_depreciado: ~0 rows (aproximadamente)
DELETE FROM `ingrediente_depreciado`;
/*!40000 ALTER TABLE `ingrediente_depreciado` DISABLE KEYS */;
/*!40000 ALTER TABLE `ingrediente_depreciado` ENABLE KEYS */;

-- Copiando estrutura para tabela laribolo_editado.ingrediente_depreciado_motivo
...
-- Copiando dados para a tabela laribolo_editado.ingrediente_depreciado_motivo: ~0 rows (aproximadamente)
DELETE FROM `ingrediente_depreciado_motivo`;
/*!40000 ALTER TABLE `ingrediente_depreciado_motivo` DISABLE KEYS */;
/*!40000 ALTER TABLE `ingrediente_depreciado_motivo` ENABLE KEYS */;

-- Copiando estrutura para tabela laribolo_editado.local_cidades
...
-- Copiando dados para a tabela laribolo_editado.local_cidades: ~5.520 rows (aproximadamente)
...
-- Copiando estrutura para tabela laribolo_editado.local_enderecos
...
-- Copiando dados para a tabela laribolo_editado.local_enderecos: ~149 rows (aproximadamente)
...
-- Copiando estrutura para tabela laribolo_editado.local_logradouros
...
-- Copiando dados para a tabela laribolo_editado.local_logradouros: ~44 rows (aproximadamente)
...
-- Copiando estrutura para tabela laribolo_editado.local_ufs
...
-- Copiando dados para a tabela laribolo_editado.local_ufs: ~27 rows (aproximadamente)
...
-- Copiando estrutura para tabela laribolo_editado.paginacao
...
-- Copiando dados para a tabela laribolo_editado.paginacao: ~0 rows (aproximadamente)
DELETE FROM `paginacao`;
/*!40000 ALTER TABLE `paginacao` DISABLE KEYS */;
/*!40000 ALTER TABLE `paginacao` ENABLE KEYS */;

-- Copiando estrutura para tabela laribolo_editado.pedido
...
-- Copiando dados para a tabela laribolo_editado.pedido: ~0 rows (aproximadamente)
DELETE FROM `pedido`;
/*!40000 ALTER TABLE `pedido` DISABLE KEYS */;
/*!40000 ALTER TABLE `pedido` ENABLE KEYS */;

-- Copiando estrutura para tabela laribolo_editado.pedidos_itens
...
CREATE TABLE IF NOT EXISTS `pedidos_itens` (
  ...
  CONSTRAINT `idmanufat.pedidositens-manufat.id` FOREIGN KEY (`id_manufaturado`) REFERENCES `pratos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela laribolo_editado.pedidos_itens: ~0 rows (aproximadamente)
DELETE FROM `pedidos_itens`;
/*!40000 ALTER TABLE `pedidos_itens` DISABLE KEYS */;
/*!40000 ALTER TABLE `pedidos_itens` ENABLE KEYS */;

-- Copiando estrutura para tabela laribolo_editado.pedido_preparacao_produtos
...
CREATE TABLE IF NOT EXISTS `pedido_preparacao_produtos` (
  ...
  `quantidade_compra_item` float(10,2) NOT NULL DEFAULT '0.00',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela laribolo_editado.pedido_preparacao_produtos: ~10 rows (aproximadamente)
DELETE FROM `pedido_preparacao_produtos`;
/*!40000 ALTER TABLE `pedido_preparacao_produtos` DISABLE KEYS */;
INSERT INTO `pedido_preparacao_produtos` (`id`, `id_pedido_preparacao`, `id_pedido_reposicao`, `id_compra_item`, `quantidade_compra_item`) VALUES
	(7, 2, NULL, 1, 120.00),
	(8, 2, NULL, 2, 120.00),
	(9, 2, NULL, 3, 12.00),
	(10, 2, NULL, 4, 3.60),
...
-- Copiando estrutura para tabela laribolo_editado.pedido_preparacoes
...
-- Copiando dados para a tabela laribolo_editado.pedido_preparacoes: ~2 rows (aproximadamente)
...
-- Copiando estrutura para tabela laribolo_editado.pedido_reposicao_ingrediente
...
-- Copiando dados para a tabela laribolo_editado.pedido_reposicao_ingrediente: ~0 rows (aproximadamente)
DELETE FROM `pedido_reposicao_ingrediente`;
/*!40000 ALTER TABLE `pedido_reposicao_ingrediente` DISABLE KEYS */;
/*!40000 ALTER TABLE `pedido_reposicao_ingrediente` ENABLE KEYS */;

-- Copiando estrutura para tabela laribolo_editado.pratos
...
-- Copiando dados para a tabela laribolo_editado.pratos: ~10 rows (aproximadamente)
DELETE FROM `pratos`;
...
-- Copiando estrutura para tabela laribolo_editado.prato_produto_manufaturados
...
CREATE TABLE IF NOT EXISTS `prato_produto_manufaturados` (
  ...
  CONSTRAINT `id_ingrediente_parte.produto_ingr_parte-id.ingr_parte` FOREIGN KEY (`id_ingrediente_parte`) REFERENCES `produto_manufaturados` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `id_produto.produto_ingr_parte-id.produto` FOREIGN KEY (`id_produto`) REFERENCES `pratos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='Prato produto manufaturado';

-- Copiando dados para a tabela laribolo_editado.prato_produto_manufaturados: ~3 rows (aproximadamente)
DELETE FROM `prato_produto_manufaturados`;
/*!40000 ALTER TABLE `prato_produto_manufaturados` DISABLE KEYS */;
INSERT INTO `prato_produto_manufaturados` (`id`, `id_produto`, `id_ingrediente_parte`) VALUES
	(1, 1, 2),
	(2, 2, 2),
	(3, 4, 3);
/*!40000 ALTER TABLE `prato_produto_manufaturados` ENABLE KEYS */;

-- Copiando estrutura para tabela laribolo_editado.produtos
...
-- Copiando dados para a tabela laribolo_editado.produtos: ~22 rows (aproximadamente)
DELETE FROM `produtos`;
/*!40000 ALTER TABLE `produtos` DISABLE KEYS */;
INSERT INTO `produtos` (`id`, `nome`, `unidade_medida`) VALUES
	(1, 'Farinha', 2),
	(2, 'Açucar', 2),
	(3, 'Fermento', 2),
	(4, 'Ovo', 1),
...
-- Copiando estrutura para tabela laribolo_editado.produto_manufaturados
...
-- Copiando dados para a tabela laribolo_editado.produto_manufaturados: ~2 rows (aproximadamente)
...
-- Copiando estrutura para tabela laribolo_editado.produto_manufaturado_configuracoes
...
CREATE TABLE IF NOT EXISTS `produto_manufaturado_configuracoes` (
  ...
  CONSTRAINT `id_ingrediente.ingrediente_configuracao-id.ingrediente` FOREIGN KEY (`id_ingradiente`) REFERENCES `produtos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `id_ingrediente_parte.ingrdiente_config-id.ingrediente_parte` FOREIGN KEY (`id_ingrediente_parte`) REFERENCES `produto_manufaturados` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Produto manufaturado configurações';

-- Copiando dados para a tabela laribolo_editado.produto_manufaturado_configuracoes: ~10 rows (aproximadamente)
DELETE FROM `produto_manufaturado_configuracoes`;
/*!40000 ALTER TABLE `produto_manufaturado_configuracoes` DISABLE KEYS */;
INSERT INTO `produto_manufaturado_configuracoes` (`id`, `id_ingrediente_parte`, `id_ingradiente`, `quantidade`) VALUES
	(1, 2, 1, 20.00),
	(2, 2, 2, 20.00),
	(3, 2, 3, 2.00),
	(4, 2, 4, 0.60),
...
-- Copiando estrutura para tabela laribolo_editado.saida
...
-- Copiando dados para a tabela laribolo_editado.saida: ~10 rows (aproximadamente)
DELETE FROM `saida`;
/*!40000 ALTER TABLE `saida` DISABLE KEYS */;
INSERT INTO `saida` (`id`, `classificacao_saida`, `id_pedido_preparacao_produto`, `id_produto_disperdicio`, `id_entrada`) VALUES
	(1, 'P', 11, NULL, 9),
	(2, 'P', 12, NULL, 4),
	(3, 'P', 13, NULL, 10),
	(4, 'P', 14, NULL, 8),
...
-- Copiando estrutura para tabela laribolo_editado.unidade_medida
...
-- Copiando dados para a tabela laribolo_editado.unidade_medida: ~3 rows (aproximadamente)
...
-- Copiando estrutura para tabela laribolo_editado.usuario
...
-- Copiando dados para a tabela laribolo_editado.usuario: ~0 rows (aproximadamente)
DELETE FROM `usuario`;
