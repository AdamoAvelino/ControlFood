...
-- Copiando estrutura do banco de dados para base_antiga
DROP DATABASE IF EXISTS `base_antiga`;
CREATE DATABASE IF NOT EXISTS `base_antiga` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `base_antiga`;

-- Copiando estrutura para tabela base_antiga.cliente
...
CREATE TABLE IF NOT EXISTS `cliente` (
  ...
  CONSTRAINT `id_endereco.cliente-endereco.id` FOREIGN KEY (`id_endereco`) REFERENCES `local_enderecos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=152 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela base_antiga.cliente: ~149 rows (aproximadamente)
DELETE FROM `cliente`;
...
-- Copiando estrutura para tabela base_antiga.compra
...
-- Copiando dados para a tabela base_antiga.compra: ~3 rows (aproximadamente)
DELETE FROM `compra`;
/*!40000 ALTER TABLE `compra` DISABLE KEYS */;
INSERT INTO `compra` (`id`, `data_compra`) VALUES
	(1, '2019-04-28 12:48:39'),
	(2, '2019-04-28 12:48:51'),
	(3, '2019-05-19 18:14:45');
/*!40000 ALTER TABLE `compra` ENABLE KEYS */;

-- Copiando estrutura para tabela base_antiga.compra_item
...
CREATE TABLE IF NOT EXISTS `compra_item` (
  ...
  KEY `id_ingrediente.compra_item-ingrediente.id` (`id_produto`) USING BTREE,
  CONSTRAINT `id_compra.compra_item-compra.id` FOREIGN KEY (`id_compra`) REFERENCES `compra` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `id_produto.compra_item-produtos.id` FOREIGN KEY (`id_produto`) REFERENCES `produtos` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela base_antiga.compra_item: ~11 rows (aproximadamente)
DELETE FROM `compra_item`;
/*!40000 ALTER TABLE `compra_item` DISABLE KEYS */;
INSERT INTO `compra_item` (`id`, `id_compra`, `id_produto`, `quantidade`) VALUES
	(1, 1, 10, 3),
	(2, 1, 2, 1),
	(3, 1, 7, 5),
	(4, 2, 8, 2),
...
-- Copiando estrutura para tabela base_antiga.entrada
DROP TABLE IF EXISTS `entrada`;
CREATE TABLE IF NOT EXISTS `entrada` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_nota_fiscal` int(11) DEFAULT NULL,
  `id_nota_fiscal_item` int(11) DEFAULT NULL,
  `id_produto` int(11) DEFAULT NULL COMMENT 'Indice como referencia',
  `quantidade_produto` float(10,2) DEFAULT NULL,
  `quantidade_embalagem` float(10,2) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `id_compra.entrada-id_compra.itemcompra_idx` (`id_nota_fiscal`) USING BTREE,
  KEY `id_item_compra.entrada-id.item_compra` (`id_nota_fiscal_item`) USING BTREE,
  KEY `id_produto` (`id_produto`),
  CONSTRAINT `id_nota_fiscal.entrada-nota_fiscal_itens.id_nota_fiscal` FOREIGN KEY (`id_nota_fiscal`) REFERENCES `nota_fiscal_items` (`id_nota_fiscal`),
  CONSTRAINT `id_nota_fiscal_item.entrada-nota_fiscal_items.id` FOREIGN KEY (`id_nota_fiscal_item`) REFERENCES `nota_fiscal_items` (`id`),
  CONSTRAINT `id_produto.entrada-produtos.id` FOREIGN KEY (`id_produto`) REFERENCES `produtos` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela base_antiga.entrada: ~0 rows (aproximadamente)
DELETE FROM `entrada`;
/*!40000 ALTER TABLE `entrada` DISABLE KEYS */;
/*!40000 ALTER TABLE `entrada` ENABLE KEYS */;

-- Copiando estrutura para tabela base_antiga.entrega
...
-- Copiando dados para a tabela base_antiga.entrega: ~0 rows (aproximadamente)
DELETE FROM `entrega`;
/*!40000 ALTER TABLE `entrega` DISABLE KEYS */;
/*!40000 ALTER TABLE `entrega` ENABLE KEYS */;

-- Copiando estrutura para tabela base_antiga.fornecedor
DROP TABLE IF EXISTS `fornecedor`;
CREATE TABLE IF NOT EXISTS `fornecedor` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_local_endereco` int(11) unsigned DEFAULT NULL,
  `nome` varchar(250) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `id_local_endereco.fornecedor-endereco.id` (`id_local_endereco`),
  CONSTRAINT `id_local_endereco.fornecedor-endereco.id` FOREIGN KEY (`id_local_endereco`) REFERENCES `local_enderecos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela base_antiga.fornecedor: ~0 rows (aproximadamente)
DELETE FROM `fornecedor`;
/*!40000 ALTER TABLE `fornecedor` DISABLE KEYS */;
/*!40000 ALTER TABLE `fornecedor` ENABLE KEYS */;

-- Copiando estrutura para tabela base_antiga.local_cidades
...
CREATE TABLE IF NOT EXISTS `local_cidades` (
  ...
  CONSTRAINT `id_uf.cidade-uf.id` FOREIGN KEY (`id_uf`) REFERENCES `local_ufs` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=5565 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela base_antiga.local_cidades: ~5.520 rows (aproximadamente)
DELETE FROM `local_cidades`;
/*!40000 ALTER TABLE `local_cidades` DISABLE KEYS */;
INSERT INTO `local_cidades` (`id`, `cidade`, `id_uf`) VALUES
	(1, 'Afonso Cláudio', 8),
	...
	(5564, 'Xambioá', 27);
/*!40000 ALTER TABLE `local_cidades` ENABLE KEYS */;

-- Copiando estrutura para tabela base_antiga.local_enderecos
...
CREATE TABLE IF NOT EXISTS `local_enderecos` (
  ...
  CONSTRAINT `id_cidade.endereco-cidade.id` FOREIGN KEY (`id_cidade`) REFERENCES `local_cidades` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `id_logradouro.endereco-logradouro.id` FOREIGN KEY (`id_logradouro`) REFERENCES `local_logradouros` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=156 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela base_antiga.local_enderecos: ~149 rows (aproximadamente)
DELETE FROM `local_enderecos`;
/*!40000 ALTER TABLE `local_enderecos` DISABLE KEYS */;
INSERT INTO `local_enderecos` (`id`, `id_logradouro`, `cep`, `nome_logradouro`, `numero`, `complemento`, `id_cidade`) VALUES
...
/*!40000 ALTER TABLE `local_enderecos` ENABLE KEYS */;

-- Copiando estrutura para tabela base_antiga.local_logradouros
DROP TABLE IF EXISTS `local_logradouros`;
CREATE TABLE IF NOT EXISTS `local_logradouros` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `logradouro` char(50) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela base_antiga.local_logradouros: ~44 rows (aproximadamente)
DELETE FROM `local_logradouros`;
/*!40000 ALTER TABLE `local_logradouros` DISABLE KEYS */;
INSERT INTO `local_logradouros` (`id`, `logradouro`) VALUES
	(2, 'Aeroporto'),
	(3, 'Alameda'),
	(4, 'Área'),
	(5, 'Avenida'),
	...
	(44, 'Viela'),
	(45, 'Vila');
/*!40000 ALTER TABLE `local_logradouros` ENABLE KEYS */;

-- Copiando estrutura para tabela base_antiga.local_ufs
DROP TABLE IF EXISTS `local_ufs`;
CREATE TABLE IF NOT EXISTS `local_ufs` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- Copiando dados para a tabela base_antiga.local_ufs: ~27 rows (aproximadamente)
DELETE FROM `local_ufs`;
/*!40000 ALTER TABLE `local_ufs` DISABLE KEYS */;
INSERT INTO `local_ufs` (`id`, `estado`, `uf`) VALUES
	(1, 'Acre', 'AC'),
	(2, 'Alagoas', 'AL'),
	(3, 'Amazonas', 'AM'),
	(4, 'Amapá', 'AP'),
	...
	(26, 'São Paulo', 'SP'),
	(27, 'Tocantins', 'TO');
/*!40000 ALTER TABLE `local_ufs` ENABLE KEYS */;

-- Copiando estrutura para tabela base_antiga.nota_fiscal
...
CREATE TABLE IF NOT EXISTS `nota_fiscal` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_fornecedor.nota_fiscal-fornecedor.id` (`id_fornecedor`),
  CONSTRAINT `id_fornecedor.nota_fiscal-fornecedor.id` FOREIGN KEY (`id_fornecedor`) REFERENCES `fornecrdor` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela base_antiga.nota_fiscal: ~0 rows (aproximadamente)
DELETE FROM `nota_fiscal`;
/*!40000 ALTER TABLE `nota_fiscal` DISABLE KEYS */;
/*!40000 ALTER TABLE `nota_fiscal` ENABLE KEYS */;

-- Copiando estrutura para tabela base_antiga.nota_fiscal_compra
DROP TABLE IF EXISTS `nota_fiscal_compra`;
CREATE TABLE IF NOT EXISTS `nota_fiscal_compra` (
  `id_nota_fiscal` int(11) NOT NULL,
  `id_compra` int(11) NOT NULL,
  PRIMARY KEY (`id_nota_fiscal`,`id_compra`),
  KEY `id_compra.nota_fiscal_item-compra.id` (`id_compra`),
  KEY `id_nota_fiscal` (`id_nota_fiscal`),
  CONSTRAINT `id_compra.nota_fiscal_item-compra.id` FOREIGN KEY (`id_compra`) REFERENCES `compra` (`id`),
  CONSTRAINT `id_nota_fiscal.nota_item_fiscal-nota_fiscal.id` FOREIGN KEY (`id_nota_fiscal`) REFERENCES `nota_fiscal` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela base_antiga.nota_fiscal_compra: ~0 rows (aproximadamente)
DELETE FROM `nota_fiscal_compra`;
/*!40000 ALTER TABLE `nota_fiscal_compra` DISABLE KEYS */;
/*!40000 ALTER TABLE `nota_fiscal_compra` ENABLE KEYS */;

-- Copiando estrutura para tabela base_antiga.nota_fiscal_items
DROP TABLE IF EXISTS `nota_fiscal_items`;
CREATE TABLE IF NOT EXISTS `nota_fiscal_items` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_nota_fiscal` int(11) NOT NULL,
  `quantidate` float(10,2) unsigned NOT NULL DEFAULT '0.00',
  `quantidade_embalagem` float(10,2) unsigned NOT NULL DEFAULT '0.00',
  PRIMARY KEY (`id`),
  KEY `id_nota_fiscal.nota_fiscal_items-nota_fiscal.id` (`id_nota_fiscal`),
  CONSTRAINT `id_nota_fiscal.nota_fiscal_items-nota_fiscal.id` FOREIGN KEY (`id_nota_fiscal`) REFERENCES `nota_fiscal` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela base_antiga.nota_fiscal_items: ~0 rows (aproximadamente)
DELETE FROM `nota_fiscal_items`;
/*!40000 ALTER TABLE `nota_fiscal_items` DISABLE KEYS */;
/*!40000 ALTER TABLE `nota_fiscal_items` ENABLE KEYS */;

-- Copiando estrutura para tabela base_antiga.paginacao
DROP TABLE IF EXISTS `paginacao`;
CREATE TABLE IF NOT EXISTS `paginacao` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `entidade` varchar(100) NOT NULL,
  `limite` smallint(6) NOT NULL DEFAULT '10',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela base_antiga.paginacao: ~0 rows (aproximadamente)
DELETE FROM `paginacao`;
/*!40000 ALTER TABLE `paginacao` DISABLE KEYS */;
/*!40000 ALTER TABLE `paginacao` ENABLE KEYS */;

-- Copiando estrutura para tabela base_antiga.pedido
...
-- Copiando dados para a tabela base_antiga.pedido: ~0 rows (aproximadamente)
DELETE FROM `pedido`;
/*!40000 ALTER TABLE `pedido` DISABLE KEYS */;
/*!40000 ALTER TABLE `pedido` ENABLE KEYS */;

-- Copiando estrutura para tabela base_antiga.pedidos_itens
DROP TABLE IF EXISTS `pedidos_itens`;
CREATE TABLE IF NOT EXISTS `pedidos_itens` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_produto_manufaturado` int(11) DEFAULT NULL,
  `id_produto` int(11) DEFAULT NULL,
  `id_prato` int(11) DEFAULT NULL,
  `id_pedido` int(11) NOT NULL,
  `valor_item` float(10,2) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_pedidos_itens_pedido` (`id_pedido`),
  KEY `id_produto_manuf.pedido_items-produto_manuf.id` (`id_produto_manufaturado`),
  KEY `id_produto.pedido_items-produtos.id` (`id_produto`),
  KEY `id_prato.pedido_items-pratos.id` (`id_prato`),
  CONSTRAINT `FK_pedidos_itens_pedido` FOREIGN KEY (`id_pedido`) REFERENCES `pedido` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `id_prato.pedido_items-pratos.id` FOREIGN KEY (`id_prato`) REFERENCES `pratos` (`id`),
  CONSTRAINT `id_produto.pedido_items-produtos.id` FOREIGN KEY (`id_produto`) REFERENCES `produtos` (`id`),
  CONSTRAINT `id_produto_manuf.pedido_items-produto_manuf.id` FOREIGN KEY (`id_produto_manufaturado`) REFERENCES `produto_manufaturados` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela base_antiga.pedidos_itens: ~0 rows (aproximadamente)
DELETE FROM `pedidos_itens`;
/*!40000 ALTER TABLE `pedidos_itens` DISABLE KEYS */;
/*!40000 ALTER TABLE `pedidos_itens` ENABLE KEYS */;

-- Copiando estrutura para tabela base_antiga.pedido_item_manufaturado
DROP TABLE IF EXISTS `pedido_item_manufaturado`;
CREATE TABLE IF NOT EXISTS `pedido_item_manufaturado` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_pedido_item` int(11) NOT NULL,
  `id_produto_manufaturado` int(11) NOT NULL,
  `id_prato` int(11) NOT NULL,
  `valor_item_manufaturado` float(10,2) NOT NULL DEFAULT '0.00',
  PRIMARY KEY (`id`),
  KEY `id_pedido_item.pedido_item_manuf-pedido_items.id` (`id_pedido_item`),
  KEY `id_produto_manuf.pedido_item_manuf-pedido_items.id_prod_ma` (`id_produto_manufaturado`),
  KEY `id_prato.pedido_item_manuf-pedido_items.id_prato` (`id_prato`),
  CONSTRAINT `id_pedido_item.pedido_item_manuf-pedido_items.id` FOREIGN KEY (`id_pedido_item`) REFERENCES `pedidos_itens` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `id_prato.pedido_item_manuf-pedido_items.id_prato` FOREIGN KEY (`id_prato`) REFERENCES `pedidos_itens` (`id_prato`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `id_produto_manuf.pedido_item_manuf-pedido_items.id_prod_ma` FOREIGN KEY (`id_produto_manufaturado`) REFERENCES `pedidos_itens` (`id_produto_manufaturado`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela base_antiga.pedido_item_manufaturado: ~0 rows (aproximadamente)
DELETE FROM `pedido_item_manufaturado`;
/*!40000 ALTER TABLE `pedido_item_manufaturado` DISABLE KEYS */;
/*!40000 ALTER TABLE `pedido_item_manufaturado` ENABLE KEYS */;

-- Copiando estrutura para tabela base_antiga.pedido_preparacao_produtos
DROP TABLE IF EXISTS `pedido_preparacao_produtos`;
CREATE TABLE IF NOT EXISTS `pedido_preparacao_produtos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_pedido_preparacao` int(11) NOT NULL DEFAULT '0',
  `id_pedido_reposicao` int(11) DEFAULT NULL,
  `quantidade` float(10,2) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `id_pedido_preparacao.ped_prep_pro-ped_prep.id` (`id_pedido_preparacao`),
  KEY `id_pedido_reposicao.ped_prep_pro.ped_rep.id` (`id_pedido_reposicao`),
  CONSTRAINT `id_pedido_preparacao.ped_prep_pro-ped_prep.id` FOREIGN KEY (`id_pedido_preparacao`) REFERENCES `pedido_preparacoes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `id_pedido_reposicao.ped_prep_pro.ped_rep.id` FOREIGN KEY (`id_pedido_reposicao`) REFERENCES `pedido_reposicao_produto` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela base_antiga.pedido_preparacao_produtos: ~5 rows (aproximadamente)
DELETE FROM `pedido_preparacao_produtos`;
/*!40000 ALTER TABLE `pedido_preparacao_produtos` DISABLE KEYS */;
INSERT INTO `pedido_preparacao_produtos` (`id`, `id_pedido_preparacao`, `id_pedido_reposicao`, `quantidade`) VALUES
	(7, 2, NULL, 120.00),
	(8, 2, NULL, 120.00),
	(9, 2, NULL, 12.00),
	(10, 2, NULL, 3.60),
	...
	(15, 1, NULL, 83.50),
	(16, 1, NULL, 83.50);
/*!40000 ALTER TABLE `pedido_preparacao_produtos` ENABLE KEYS */;

-- Copiando estrutura para tabela base_antiga.pedido_preparacoes
DROP TABLE IF EXISTS `pedido_preparacoes`;
CREATE TABLE IF NOT EXISTS `pedido_preparacoes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `data_pedido` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela base_antiga.pedido_preparacoes: ~2 rows (aproximadamente)
DELETE FROM `pedido_preparacoes`;
/*!40000 ALTER TABLE `pedido_preparacoes` DISABLE KEYS */;
INSERT INTO `pedido_preparacoes` (`id`, `data_pedido`) VALUES
	(1, '2019-05-19 13:35:50'),
	(2, '2019-05-19 13:36:04');
/*!40000 ALTER TABLE `pedido_preparacoes` ENABLE KEYS */;

-- Copiando estrutura para tabela base_antiga.pedido_reposicao_produto
DROP TABLE IF EXISTS `pedido_reposicao_produto`;
CREATE TABLE IF NOT EXISTS `pedido_reposicao_produto` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `data_pedido` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela base_antiga.pedido_reposicao_produto: ~0 rows (aproximadamente)
DELETE FROM `pedido_reposicao_produto`;
/*!40000 ALTER TABLE `pedido_reposicao_produto` DISABLE KEYS */;
/*!40000 ALTER TABLE `pedido_reposicao_produto` ENABLE KEYS */;

-- Copiando estrutura para tabela base_antiga.pratos
...
CREATE TABLE IF NOT EXISTS `pratos` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='Prato';

-- Copiando dados para a tabela base_antiga.pratos: ~10 rows (aproximadamente)
DELETE FROM `pratos`;
/*!40000 ALTER TABLE `pratos` DISABLE KEYS */;
INSERT INTO `pratos` (`id`, `nome`, `valor_venda`) VALUES
	(1, 'Abacaxi', 5.00),
	(2, 'Morango', 5.00),
	(3, 'Sensação', 5.00),
	(4, 'Brigadeiro', 5.00),
...
-- Copiando estrutura para tabela base_antiga.prato_produto_manufaturados
DROP TABLE IF EXISTS `prato_produto_manufaturados`;
CREATE TABLE IF NOT EXISTS `prato_produto_manufaturados` (
  `id_prato` int(11) NOT NULL,
  `id_produto_manufaturado` int(11) NOT NULL,
  UNIQUE KEY `id_prato_id_produto_manufaturado` (`id_prato`,`id_produto_manufaturado`),
  KEY `manufaturadiid.ingredimanufat-id.manufat_idx` (`id_prato`) USING BTREE,
  KEY `ingredientid.ingredimanufat-id-ingrediente_idx` (`id_produto_manufaturado`) USING BTREE,
  CONSTRAINT `id_prato.prato_produto_manuf-prato.id` FOREIGN KEY (`id_prato`) REFERENCES `pratos` (`id`),
  CONSTRAINT `id_prato.prato_produto_manuf-produto_manuf.id` FOREIGN KEY (`id_produto_manufaturado`) REFERENCES `produto_manufaturados` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Prato produto manufaturado';

-- Copiando dados para a tabela base_antiga.prato_produto_manufaturados: ~3 rows (aproximadamente)
DELETE FROM `prato_produto_manufaturados`;
/*!40000 ALTER TABLE `prato_produto_manufaturados` DISABLE KEYS */;
INSERT INTO `prato_produto_manufaturados` (`id_prato`, `id_produto_manufaturado`) VALUES
	(1, 2),
	(2, 2),
	(4, 3);
/*!40000 ALTER TABLE `prato_produto_manufaturados` ENABLE KEYS */;

-- Copiando estrutura para tabela base_antiga.produtos
...
CREATE TABLE IF NOT EXISTS `produtos` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_unidade_medida.produtos-unidade_medida.id` (`id_unidade_medida`),
  CONSTRAINT `id_unidade_medida.produtos-unidade_medida.id` FOREIGN KEY (`id_unidade_medida`) REFERENCES `unidade_medida` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='Produto';

-- Copiando dados para a tabela base_antiga.produtos: ~22 rows (aproximadamente)
DELETE FROM `produtos`;
/*!40000 ALTER TABLE `produtos` DISABLE KEYS */;
INSERT INTO `produtos` (`id`, `nome`, `id_unidade_medida`) VALUES
	(1, 'Farinha', 2),
	(2, 'Açucar', 2),
	(3, 'Fermento', 2),
	(4, 'Ovo', 1),
...
-- Copiando estrutura para tabela base_antiga.produto_disperdicio
DROP TABLE IF EXISTS `produto_disperdicio`;
CREATE TABLE IF NOT EXISTS `produto_disperdicio` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_compra_item` int(11) NOT NULL,
  `id_produto_disperdicio_motivo` int(11) NOT NULL,
  `quantidade_disperdicio` float(10,2) NOT NULL DEFAULT '0.00',
  PRIMARY KEY (`id`),
  KEY `idcompitem.ingredepre-compitem.id` (`id_compra_item`),
  KEY `idingrdepremot.igredepre-ingrdepremot.id` (`id_produto_disperdicio_motivo`) USING BTREE,
  CONSTRAINT `id_produto_disperdicio_motivo.prod_dis_mot-prod_disp.id` FOREIGN KEY (`id_produto_disperdicio_motivo`) REFERENCES `produto_disperdicio_motivo` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Copiando dados para a tabela base_antiga.produto_disperdicio: ~0 rows (aproximadamente)
DELETE FROM `produto_disperdicio`;
/*!40000 ALTER TABLE `produto_disperdicio` DISABLE KEYS */;
/*!40000 ALTER TABLE `produto_disperdicio` ENABLE KEYS */;

-- Copiando estrutura para tabela base_antiga.produto_disperdicio_motivo
DROP TABLE IF EXISTS `produto_disperdicio_motivo`;
CREATE TABLE IF NOT EXISTS `produto_disperdicio_motivo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Copiando dados para a tabela base_antiga.produto_disperdicio_motivo: ~0 rows (aproximadamente)
DELETE FROM `produto_disperdicio_motivo`;
/*!40000 ALTER TABLE `produto_disperdicio_motivo` DISABLE KEYS */;
/*!40000 ALTER TABLE `produto_disperdicio_motivo` ENABLE KEYS */;

-- Copiando estrutura para tabela base_antiga.produto_manufaturados
DROP TABLE IF EXISTS `produto_manufaturados`;
CREATE TABLE IF NOT EXISTS `produto_manufaturados` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nome` varchar(100) NOT NULL,
  `descricao` varchar(250) NOT NULL,
  `data_criacao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='Prato Manufaturado';

-- Copiando dados para a tabela base_antiga.produto_manufaturados: ~2 rows (aproximadamente)
DELETE FROM `produto_manufaturados`;
/*!40000 ALTER TABLE `produto_manufaturados` DISABLE KEYS */;
INSERT INTO `produto_manufaturados` (`id`, `nome`, `descricao`, `data_criacao`) VALUES
	(2, 'Bolo de Pote Massa Branca', '', '2019-05-01 10:41:54'),
	(3, 'Bolo de Pote Massa Escura', '', '2019-05-01 10:42:09');
/*!40000 ALTER TABLE `produto_manufaturados` ENABLE KEYS */;

-- Copiando estrutura para tabela base_antiga.produto_manufaturado_configuracoes
DROP TABLE IF EXISTS `produto_manufaturado_configuracoes`;
CREATE TABLE IF NOT EXISTS `produto_manufaturado_configuracoes` (
  `id` int(11) NOT NULL,
  `id_produto_manufaturado` int(11) NOT NULL,
  `id_produto` int(11) NOT NULL,
  `quantidade` float(10,2) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `id_produto_manuf.produto_manuf_conf-produto_manufaturado.id` (`id_produto_manufaturado`),
  KEY `id_produto.produto_manuf_conf-produto.id` (`id_produto`),
  CONSTRAINT `id_produto.produto_manuf_conf-produto.id` FOREIGN KEY (`id_produto`) REFERENCES `produtos` (`id`),
  CONSTRAINT `id_produto_manuf.produto_manuf_conf-produto_manufaturado.id` FOREIGN KEY (`id_produto_manufaturado`) REFERENCES `produto_manufaturados` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Produto manufaturado configurações';

-- Copiando dados para a tabela base_antiga.produto_manufaturado_configuracoes: ~10 rows (aproximadamente)
DELETE FROM `produto_manufaturado_configuracoes`;
/*!40000 ALTER TABLE `produto_manufaturado_configuracoes` DISABLE KEYS */;
INSERT INTO `produto_manufaturado_configuracoes` (`id`, `id_produto_manufaturado`, `id_produto`, `quantidade`) VALUES
	(1, 2, 1, 20.00),
	(2, 2, 2, 20.00),
	(3, 2, 3, 2.00),
	(4, 2, 4, 0.60),
	...
	(9, 3, 5, 16.70),
	(10, 3, 6, 16.70);
/*!40000 ALTER TABLE `produto_manufaturado_configuracoes` ENABLE KEYS */;

-- Copiando estrutura para tabela base_antiga.saida
DROP TABLE IF EXISTS `saida`;
CREATE TABLE IF NOT EXISTS `saida` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `classificacao_saida` char(1) NOT NULL DEFAULT '',
  `id_pedido_preparacao_produto` int(11) DEFAULT NULL,
  `id_produto_disperdicio` int(11) DEFAULT NULL,
  `id_entrada` int(11) DEFAULT NULL,
  `quantidade` float(10,2) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `id_entrada.saida-entrada.id` (`id_entrada`),
  KEY `idingrdepre.saida-ingrdepr.id` (`id_produto_disperdicio`) USING BTREE,
  KEY `idprepingre.saida-prepingre.id` (`id_pedido_preparacao_produto`) USING BTREE,
  CONSTRAINT `id_entrada.siada-entrada.id` FOREIGN KEY (`id_entrada`) REFERENCES `entrada` (`id`),
  CONSTRAINT `id_pedido_pre_prod.saida-pedido_pre_pro.id` FOREIGN KEY (`id_pedido_preparacao_produto`) REFERENCES `pedido_preparacao_produtos` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela base_antiga.saida: ~0 rows (aproximadamente)
DELETE FROM `saida`;
/*!40000 ALTER TABLE `saida` DISABLE KEYS */;
/*!40000 ALTER TABLE `saida` ENABLE KEYS */;

-- Copiando estrutura para tabela base_antiga.unidade_medida
...
-- Copiando dados para a tabela base_antiga.unidade_medida: ~3 rows (aproximadamente)
...
-- Copiando estrutura para tabela base_antiga.usuario
...
-- Copiando dados para a tabela base_antiga.usuario: ~0 rows (aproximadamente)
DELETE FROM `usuario`;
